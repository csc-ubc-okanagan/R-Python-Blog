...
tags: [R, data visualization, ggplot, colorblind] # tags always lowercase
...
The default color palettes ggplot provides are generally good enough for a quick check, but they are overused and do not have very high contrast:
...
```{r, echo=FALSE}
knitr::include_graphics('../figures/khroma-function-help.png')
```
...
To read the help files for any of the functions in the pakcages, use the `?` function, e.g. `?`
