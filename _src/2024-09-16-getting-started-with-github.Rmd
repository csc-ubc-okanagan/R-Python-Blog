...
```{r}
knitr::include_graphics('../figures/intro-to-gh/new-repo.png')
```
...
```{r}
knitr::include_graphics('../figures/intro-to-gh/new-repo-options.png')
```
...
```{r}
knitr::include_graphics('../figures/intro-to-gh/publish-repo.png')
```
...
```{r}
knitr::include_graphics('../figures/intro-to-gh/push-origin.png')
```
